...
use Libraries\TinyPHP\Db\RandomData\FirstName AS FirstName_Model;
use Libraries\TinyPHP\Db\RandomData\Tables\FirstName AS FirstName_Table;
class FirstName implements IMappable
{
    private $_table;
    ...
    {
        if($this->_table === null){
            $this->_table = new FirstName_Table();
        }
        return $this->_table;
    }
