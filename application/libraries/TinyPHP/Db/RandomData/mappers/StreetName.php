...
use Libraries\TinyPHP\Db\RandomData\StreetName AS StreetName_Model;
use Libraries\TinyPHP\Db\RandomData\Tables\StreetName AS StreetName_Table;
class StreetName implements IMappable
{
    private $_table;
    ...
    {
        if($this->_table === null){
            $this->_table = new StreetName_Table();
        }
        return $this->_table;
    }
    ...
    {
	$obj->setId($row['id']);
	$obj->setStreetName($row['street_name']);
    }
}